...
def testNet(net, val_loader, val_set, out_dir, crop):
    ...
    with torch.no_grad():
         ...
         #utils_test.testAndSaveCrop(net, val_loader, val_set, fout=fout, out_dir=out_dir, pad_size=16, crop_size=256)
#         if crop!=True:
#             p_psnr = utils_test.evalPsnr(net, val_loader, val_set, fout=fout, out_dir=out_dir)
#         else:
#             p_psnr = utils_test.testAndSaveCrop(net, val_loader, val_set, fout=fout, out_dir=out_dir, pad_size=16, crop_size=256)
